...
def mitm(buff, direction, shared):
  """
  Attempt a packet modification attack where buffers are increased tenfold in size.
  """
  hb = "".join("{:02x}".format(ord(c)) for c in buff)
  x = re.search('f756e74270a70340a5327(.+)270a70350a735327616d6f756e', hb)
  account = x.group(1).decode("hex")
