...
def mitm(buff, direction, shared):
  """
  Attempt a reflection attack on the ATM where we reflect all packets
  created by the ATM back to itself instead of sending the real packets
  coming from the bank.
  """
  shared.put({"type": "card_contents", "cardfile": "ted.card", "content": ""})
